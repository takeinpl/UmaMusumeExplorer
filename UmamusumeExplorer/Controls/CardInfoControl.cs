    ...
    public partial class CardInfoControl : UserControl
    {
        ...
        private void CostumeSelectComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                iconPinnedBitmap = GameAssets.GetCharaIcon(cardData.CharaId);
        ...
        private void LoadCharaData()
        {
            ...
            iconPinnedBitmap = GameAssets.GetCharaIcon(id);
            iconPictureBox.Image = iconPinnedBitmap?.Bitmap;
        ...
        private void UpdateStats(CardData cardData, CardRarityData cardRarityData, int level)
        {
            ...
            turfRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperGroundTurf;
            dirtRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperGroundDirt;

            sprintRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperDistanceShort;
            mileRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperDistanceMile;
            mediumRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperDistanceMiddle;
            longRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperDistanceLong;

            frontRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperRunningStyleNige;
            paceRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperRunningStyleSenko;
            lateRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperRunningStyleSashi;
            endRankedLabel.Rank = (AptitudeRank)cardRarityData.ProperRunningStyleOikomi;
        ...
        private void UpdateIconAndStats()
        {
            ...
            iconPinnedBitmap?.Dispose();
            iconPinnedBitmap = GameAssets.GetCharaIcon(cardData.CharaId, rarityData.RaceDressId, level > 2 ? 2 : 1);
            iconPictureBox.Image = iconPinnedBitmap?.Bitmap;
