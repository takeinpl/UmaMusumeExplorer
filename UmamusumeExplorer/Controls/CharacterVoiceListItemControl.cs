...
namespace UmamusumeExplorer.Controls
{
    public partial class CharacterVoiceListItemControl : UserControl
    {
        ...
        public WaveStream? GetWaveStream()
        {
            ...
            ManifestEntry? acbAsset = AssetTables.AudioAssetEntries.FirstOrDefault(a => a.BaseName == CharacterSystemText.CueSheet + ".acb");
            ManifestEntry? awbAsset = AssetTables.AudioAssetEntries.FirstOrDefault(a => a.BaseName == CharacterSystemText.CueSheet + ".awb");
